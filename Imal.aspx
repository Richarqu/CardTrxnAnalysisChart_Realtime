<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Imal.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <h2>iMAL CARD TRANSACTION ANALYSIS</h2>
    ...
    <div class="row">
        <div class="col-xs-6">
            <asp:Chart ID="ChartATM" runat="server" Height="350px" Width="650px" OnDataBound="ChartATM_DataBound">
                    ...
                    <Series>
                        <asp:Series Name="Series2" LegendText ="Failed" ChartArea="ChartAreaATM" XValueMember="Hour" YValueMembers="Failed" Color="Orange" IsValueShownAsLabel="true" ToolTip="#YVAL" ></asp:Series>
                    </Series>
                <Series>
                        <asp:Series Name="Series3" LegendText ="Timeout" ChartArea="ChartAreaATM" XValueMember="Hour" YValueMembers="Timeout" Color="FireBrick" IsValueShownAsLabel="true" ToolTip="#YVAL" ></asp:Series>
                    </Series>
                     <Legends>
