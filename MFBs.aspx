<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="MFBs.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <h2>MFB CARD TRANSACTION ANALYSIS</h2>
    ...
    <div class="row">
        <div class="col-xs-6">
            <asp:Chart ID="ChartATM" runat="server" Height="350px" Width="650px" OnDataBound="ChartATM_DataBound">
                    <Series>
                        <asp:Series Name="Series1" LegendText ="Success" ChartArea="ChartAreaATM" XValueMember="Hour"  YValueMembers="Success" Color="LimeGreen" IsValueShownAsLabel="true" ToolTip="#YVAL"></asp:Series>
                    </Series>
                    <Series>
                        <asp:Series Name="Series2" LegendText ="Failed" ChartArea="ChartAreaATM" XValueMember="Hour" YValueMembers="Failed" Color="FireBrick" IsValueShownAsLabel="true" ToolTip="#YVAL" ></asp:Series>
                    </Series>
                     <Legends>
        ...
        <div class="col-xs-6">
            <asp:Chart ID="ChartPOS" runat="server" Height="350px" Width="650px" BorderlineWidth="10" OnDataBound="ChartPOS_DataBound">
                    ...
                    <Series>
                        <asp:Series Name="Series2" LegendText ="Failed" ChartArea="ChartAreaPOS" XValueMember="Hour" YValueMembers="Failed" Color="FireBrick" IsValueShownAsLabel="true"></asp:Series>
                    </Series>
                     <Legends>
                         <asp:Legend Docking="Bottom" Alignment="Center"></asp:Legend>
                     </Legends>
        ...
        <div class="col-xs-6">
            <asp:Chart ID="ChartOTH" runat="server" Height="350px" Width="650px" BorderlineWidth ="15" OnDataBound="ChartOTH_DataBound">
                    ...
                    <Series>
                        <asp:Series Name="Series2" LegendText ="Failed" ChartArea="ChartAreaOTH" XValueMember="Hour" YValueMembers="Failed" Color="FireBrick" IsValueShownAsLabel="true"></asp:Series>
                    </Series>
                     <Legends>
                         <asp:Legend Docking="Bottom" Alignment="Center"></asp:Legend>
                     </Legends>
